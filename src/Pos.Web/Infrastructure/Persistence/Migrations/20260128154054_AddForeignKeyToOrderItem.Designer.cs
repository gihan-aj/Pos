...
namespace Pos.Web.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260128154054_AddForeignKeyToOrderItem")]
    partial class AddForeignKeyToOrderItem
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("Pos.Web.Features.Orders.Entities.OrderItem", "OrderItems", b1 =>
                        {
                            ...
                            b1.HasOne("Pos.Web.Features.Catalog.Entities.ProductVariant", "ProductVariant")
                                .WithMany()
